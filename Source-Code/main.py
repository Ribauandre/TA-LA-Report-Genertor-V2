...
#average calculator
    ...
    def run(self):
        ...
        contentOfFile = fin.read()
        fin.close()

        fout.write(contentOfFile)
        fout.close()
...
class Generate_Master_Report(QThread):
    ...
    def run(self):
        with open(self.filepath, "r") as readfile:
            ...
            contentOfFile = contentOfFile.replace(u'\u2019', u"'")
            contentOfFile = contentOfFile.replace(u'\u201C', u"'")
            contentOfFile = contentOfFile.replace(u'\u201D', u'')
            contentOfFile = contentOfFile.replace(u'\ufeff', u'')
            contentOfFile = contentOfFile.replace(u'\xa0', u' ')
            contentOfFile = contentOfFile.replace(u'\ufeff', u'NULL')
            contentOfFile = contentOfFile.replace(u'\xa0', u' ')
            contentOfFile = contentOfFile.replace(u'\u2026', u'...')
